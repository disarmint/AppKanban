...
// editable.
export function makeTaskSchema(isCreate: boolean) {
...
// All editable task fields, shared by the compact dialog and the full task page.
// The parent owns the react-hook-form instance, submit handler, and footer.
